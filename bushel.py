...
class Bushel:
    ...
    def gen_mon(self, set_num):
        ...
        if set_num == 3:
            ...
            self.mons.insert(0, mon_choice)
        if set_num == 4:
            self.mons = Monster("Nemean Lion", 100, [Moves("Roar", 25), Moves("Swipe", 50), Moves("Smol Punch", 20)])
        if set_num == 5:
            self.mons = Monster("Lernaean Hydra", 100, [Moves("Roar", 25), Moves("Swipe", 50), Moves("Smol Punch", 20)])
        if set_num == 6:
            self.mons = Monster("Cerberus", 100, [Moves("Roar", 25), Moves("Swipe", 50), Moves("Smol Punch", 20)])